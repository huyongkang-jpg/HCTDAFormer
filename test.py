...
parser.add_argument('--checkpoint', type=str,
                    default='/home/lay/lay/code/Work2_a/HCTDAFormer_qkv/logs/2023-10-31-11:48:57-PEMS04/best_model.pth', help='')
...
def main():
    ...
    torch.save(realy,"HCTDAFormer_04real.pt")
    torch.save(yhat1,"HCTDAFormer_04pred.pt")
